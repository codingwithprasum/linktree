    ...
    <section className="bg-[#254f1a] min-h-[100vh] grid grid-cols-2">
      <div className="  flex justify-center flex-col ml-[10vw] gap-2">
        <p className="text-yellow-300 font-bold text-6xl">Everything you are.</p>
         <p className="text-yellow-300 font-bold text-6xl">In one, simple link in bio.</p>
      ...
      <div className="input flex gap-2">
        ...
        <button onClick={()=> createTree()} className="bg-pink-300 rounded-full px-4 py-4 font-semibold">Claim Your Link</button>
      </div>
      </div>
      <div className=" flex items-center justify-center flex-col m-[10vw]">
